...
var logger = new winston.Logger({
  transports: [
    ...
    new (winston.transports.File)({
      name: 'info-file',
      filename:  root_path+'/logging/'+config.logging.info_file,
      level: 'info'
    }),
    new (winston.transports.File)({
      name: 'error-file',
      filename:  root_path+'/logging/'+config.logging.error_file,
      level: 'error'
    }),
    new (winston.transports.File)({
      name: 'debug-file',
      filename:  root_path+'/logging/'+config.logging.debug_file,
      level: 'debug'
    })    
