    ...
    return new Promise(function (resolve, reject) {
      ...
      user.save(function (err, theuser) {
        if (err) {
          ...
          logger.error( chalk.red('saveUser   -- Failed to add local ')+ err);
...
function seedTheUser (user) {
  return function (password) {
    return new Promise(function (resolve, reject) {
      ...
      //logger.info('seed.js-------------',user);
      //logger.info('seed.js seedtheuser-------------',user.username , seedOptions.seedAdmin.username);
...
module.exports.start = function start(options) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    logger.info(seedOptions.seedAdmin);
    logger.info(seedOptions.seedUser);
    ...
    if (process.env.NODE_ENV === 'production') {
      ...
      //logger.debug( chalk.green( 'add both user and admin account ') );
      User.generateRandomPassphrase()
